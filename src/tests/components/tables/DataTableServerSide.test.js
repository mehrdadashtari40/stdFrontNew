...
import DataTableServerSide from '../../../common/tables/components/DataTableServerSide';
...
test('Make Snapshot file , DataTableServerSide Component', () => {
	const wrapper = shallow(<DataTableServerSide data={mockData} />);
