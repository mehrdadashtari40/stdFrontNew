...
class AllUsersFailedLogin extends React.Component {
	constructor(props) {
		super(props);
		this.state = {
			data: [],
	...
	componentDidMount() {
		this.props.loadAllLogs(
			...
			0,
			15,
			'FailedLogin && workspaces :' + config.workspace 
		);
	}
	...
	render() {
		...
		return (
			<div id="content">
				<div className="row">
					{/*<BigBreadcrumbs*/}
					{/*	items={['Logs' ,'لاگین های ناموفق کلیه کاربران']}*/}
